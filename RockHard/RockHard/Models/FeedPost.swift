...
struct FeedPost {
    ...
    static let testFeedData: [FeedPost] = [
        ...
        FeedPost(userName: "Mr. Buff Boi", contentPicture: "MrBuffManPic", creatorID: "456ABC", contentText: "I got super strong by doing 10 crunches and 5 push-ups a day!", date: "1/31/2020"),
